...
const owner1: Transport.Owner = new Transport.OwnerImpl( 'Карпачева', 'Полина', 'Олеговна', new Date('2003-04-27'), Transport.Document_type.Passport, '1234', '567890');
const owner2: Transport.Owner = new Transport.OwnerImpl( 'К', 'П', 'О', new Date('2003-01-23'), Transport.Document_type.Passport, '****', '######');
...
console.log('\n\nЗАДАНИЕ 2\n');
const matchingVehicles = carStorage.getVehiclesByOwnerDocumentSeriesAndNumber('****', '######');
